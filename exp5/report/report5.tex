...
\begin{itemize}
\item $I = 0.3 \unit{A}$ : $\alpha = 0.079\unit{Hz}$
\item $I = 0.5 \unit{A}$ : $\alpha = 0.169\unit{Hz}$
\item $I = 0.65 \unit{A}$ : $\alpha = 0.251\unit{Hz}$
\item $I = 0.8 \unit{A}$ : $\alpha = 0.380\unit{Hz}$
\end{itemize}
...
\begin{itemize}
\item $I = 0.3 \unit{A}$ : $\omega_0 = 3.0810\unit{Hz}$
\item $I = 0.5 \unit{A}$ : $\omega_0 = 3.0846\unit{Hz}$
\item $I = 0.65 \unit{A}$ : $\omega_0 = 3.0902\unit{Hz}$
\item $I = 0.8 \unit{A}$ : $\omega_0 = 3.0649\unit{Hz}$
\end{itemize}

...
The adjustable string length was set to exactly 1 Meter, simplifying calculations. We chose tensile forces of $K_1=1.5 \unit{kp} =14.7\unit{N}$ and $K_2=3.0 \unit{kp} =29.4\unit{N}$ at a later time.\\
